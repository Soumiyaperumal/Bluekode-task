  ...
  return (
    <Container>
      ...
      <Row className='pb-5 gy-5' xs={2} md={3} lg={5}>
        <Col><img src={Brand1}  alt='brandname' width='130px' height='70px'/></Col>
        <Col><img src={Brand5} className=' mt-3' alt='brandname' width='130px' height='70px'/></Col>
        <Col><img src={Brand2} alt='brandname' width='130px' height='70px'/></Col>
        <Col><img src={Brand3}  alt='brandname' width='130px' height='70px'/></Col>
        <Col><img src={Brand4}  alt='brandname' width='140px' height='90px'/></Col>
      </Row>
    </Container>
  );
}
